...
<body class="bg-blue-50">
  <nav class="fixed-top h-16 bg-slate-700 shadow-md shadow-gray-500 ">
    <div class="flex justify-between items-center">
      <div>
        <ul class="flex">
          <li>
            <button class=" bg-white rounded  pc:mr-10 mt-1 hp:ml-5 mt-2">
          ...
          <li>
            <button class="font-semibold bg-blue-400 text-white w-20 h-9 mt-3 rounded hp:hidden">BACK</button>
          </li>
        </ul>
      </div>
        <p class="text-4xl text-white text-right pr-10 hp:mb-1">E-DISCIPLINE</p>
      </div>
    </div>
  </nav>
  ...
  <div class="my-6 rounded pc:px-6 hp:px-4 hp:max mx-2">
    <div class="grid pc:grid-rows-4 hp:grid-rows-1 pc:grid-cols-4 hp:grid-cols-3 gap-4">
      <img src="foto.jpg" class="w-45 pc:h-60 hp: h-48 pc:row-span-2 hp:row-span-1  border-solid border-4 border-slate-700 pc:ml-12 hp:ml-0 mt-4 rounded"></img>
    ...
    if(distance<0){
        clearInterval(x);
        document.getElementById("demo1").innerHTML="TIDAK ADA PELANGGARAN"
    }
},1000);
    </script>
<style>
  ...
  .demo1{
        ...
        <div class="text-xl font-semibold text-center py-3">
          <P id="demo1">TIDAK ADA PELANGGARAN</P>
        </div>
      </div>
    ...
    <style>
      ...
      <button class="hp:col-span-3  bg-blue-400 active:bg-blue-800 mb-7 text-2xl text-center  hp:h-16 font-semibold rounded ">MEMBERI POIN</button>
  </div>
</body>
</html>